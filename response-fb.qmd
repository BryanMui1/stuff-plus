...
Normalize all numeric variables and apply one-hot encoding to the categorical ones:
```{r}
...
plot(perf_m, 
     ...
     main = "ROC Curve Logistic Regression(Whiff Prediction)")
...
autoplot(cm, type = "heatmap") +
  ...
  labs(title = "Confusion Matrix: Normal Logistic Regression", fill = "Count")
```
